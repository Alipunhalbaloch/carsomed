...
import afordable from '../assets/afordable.png';
...
function Entrance() {
    ...
    <div className="row" style={{backgroundColor:'#808080',height:'400px',
      ...
      <img src={suv} alt="..." className="img-thumbnail"/>
      <img src={afordable} alt="..." className="img-thumbnail"/>
      <img src={local} alt="..." className="img-thumbnail"/>
      <img src={best} alt="..." className="img-thumbnail"/>
      </div>
...
//                      style={{ backgroundImage : `url(${suv})`,width: '191px', height: '99px',  backgroundSize: 'cover' , backgroundPosition: 'center',
//                             borderRadius: '10px', marginLeft:'13px' }}>
//                         <div className="card-category"></div>
//                     </div>
//                     <div className="col-md-3" style={{ backgroundImage : `url(${afordable})`,width: '191px', height: '99px',  backgroundSize: 'cover' , backgroundPosition: 'center',
//                             borderRadius: '10px', marginLeft: '10px'}}>
//                         <div className="card-category"></div>
//                     </div>
//                     <div className="col-md-3" style={{ backgroundImage : `url(${local})`,width: '191px', height: '99px',  backgroundSize: 'cover' , backgroundPosition: 'center',
//                             borderRadius: '10px', marginLeft: '10px'}}>
//                         <div className="card-category "></div>
//                     </div>
//                     <div className="col-md-3" style={{ backgroundImage : `url(${best})`,width: '191px', height: '99px',  backgroundSize: 'cover' , backgroundPosition: 'center',
//                             borderRadius: '10px', marginLeft: '10px'}}>
//                         <div className="card-category"></div>
//                     </div>
//                 </div>
